...
vim.keymap.set('v', '<leader>d', '"_d', { noremap = true, desc = 'Delete without copying' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sh', function() builtin.find_files { cwd = vim.fn.expand '~' } end, { desc = '[S]earch Home' })
